...
function loadTable() {
  table = new Tabulator("#help_seekers_table", {
    ...
    dataFiltered: function (filters, rows) {
      ...
      help_seekers = newData;
      set_help_seeker_markers(help_seekers);
    },
...
function set_help_seeker_markers(display_info) {
  if (markerCluster) {
    markerCluster.removeMarkers(help_seeker_markers);
  }
  help_seeker_markers = help_seekers.map(function (entry, i) {
  ...
  markerCluster = new MarkerClusterer(map, help_seeker_markers,
